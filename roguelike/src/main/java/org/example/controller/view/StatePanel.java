...
/**
 * Implementation of UI element used to draw player's inventory, hp etc.
 */
...
public class StatePanel implements Drawable {
    ...
    public void moveInventorySelectorLeft() {
    ...
    public void moveInventorySelectorRight() {
    ...
    public int getFocusedInventoryItemIndex() {
